...
CREATE TABLE `wechat_user_info` (
  ...
  `user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '微信名',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_open_id_index` (`user_open_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='微信用户信息';
